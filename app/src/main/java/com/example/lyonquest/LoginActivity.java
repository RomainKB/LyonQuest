...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    /**
     * Id to identity READ_CONTACTS permission request use to the auto-completion of the e-mail.
     */
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "romain.briekekuss@gmail.com:romain", "victor.lezaud@insa-lyon.fr:victor",
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mRegistrationButton = (Button) findViewById(R.id.activity_login_registration);
